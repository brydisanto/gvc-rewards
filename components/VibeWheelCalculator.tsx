...
export default function VibeWheelCalculator() {
    ...
    return (
        <div className="w-full max-w-4xl mx-auto mt-6 mb-20 px-4">
            ...
            >
                {/* Background Glow */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-1/2 bg-gvc-orange/10 blur-[100px] pointer-events-none" />
                ...
                <div className="max-w-xl mx-auto space-y-8 relative z-10">
                        ...
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <span className="relative z-10 text-lg">REV THE VIBEWHEEL!</span>
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="bg-gradient-to-b from-white/5 to-transparent border border-gvc-gold/30 rounded-2xl p-8 space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-4xl md:text-6xl font-cooper text-gvc-orange glowing-text-orange">
                                {formatNumber(calculatedResults.vibestrBurned)} <span className="text-2xl md:text-3xl">$VIBESTR</span>
                            </p>

                            <div className="inline-block bg-gvc-orange/10 border border-gvc-orange/30 px-4 py-2 rounded-full">
                                <p className="text-gvc-orange font-mundial font-bold text-sm">
